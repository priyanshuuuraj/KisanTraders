...
const Cart = () => {
    ...
    if (!cart?.items?.length) return (
        <div className="min-h-screen flex flex-col items-center justify-center pt-20" style={{ background: "#f5f0e8" }}>
            <div className="rounded-full p-8 mb-5" style={{ background: "rgba(143,185,122,0.12)" }}>
                <ShoppingCart className="w-12 h-12" style={{ color: "#c5d9b8" }} />
            </div>
            <h2 className="text-xl font-bold mb-2" style={{ color: "#2d4a2e" }}>Your cart is empty</h2>
            <p className="text-sm mb-6" style={{ color: "#9a8a7a" }}>Add some products to get started</p>
            <Link to="/products">
    ...
    return (
        <div className="pt-20 min-h-screen" style={{ background: "#f5f0e8" }}>
            <div className="max-w-7xl mx-auto px-6 py-10">
                ...
                <h1 className="text-2xl font-bold mb-8 flex items-center gap-2" style={{ color: "#2d4a2e" }}>
                    <ShoppingCart className="w-6 h-6" style={{ color: "#8fb97a" }} />
                    Shopping Cart
                    <span className="text-sm font-normal px-2.5 py-0.5 rounded-full ml-1"
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex flex-col gap-3 flex-1">
                        {cart.items.map((product, index) => (
                            <div key={index} className="rounded-2xl p-4 border transition-shadow hover:shadow-md"
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h2 className="font-semibold text-sm line-clamp-2 mb-1" style={{ color: "#2d2d2d" }}>
                                    ...
                                    <div className="flex items-center rounded-xl overflow-hidden border"
                                        ...
                                        <span className="w-9 text-center text-sm font-bold" style={{ color: "#2d2d2d" }}>
                                            {product?.quantity}
                                        </span>
                                        <button
                                    ...
                                    {/* Line total */}
                                    <div className="w-24 text-right font-bold text-sm" style={{ color: "#2d2d2d" }}>
                    ...
                    {/* ORDER SUMMARY */}
                    <div className="w-full lg:w-[360px] h-fit rounded-2xl border p-6 space-y-4"
                        style={{ background: "#fff", borderColor: "rgba(143,185,122,0.2)" }}>
                        ...
                        <Link to="/products">
                            <button className="w-full py-3 rounded-xl font-medium text-sm border transition-all mt-2"
